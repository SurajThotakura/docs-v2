...
**Tailwind v4 users:** Add `@import "@auth0/universal-components-react/tailwind"` to your CSS file instead, and use bare variable names (`--primary`) as shown in the [shadcn tab](#).
...
:root {
  ...
  --auth0-destructive-foreground: oklch(95% 0.05 17);
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
**Tailwind v4 / shadcn users:** Add `@import "@auth0/universal-components-react/tailwind"` to your CSS file instead, and use bare variable names (`--primary`) as shown in the [shadcn tab](#).
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
The `styling` prop always uses `--auth0-*` prefixed names for colors (e.g., `--auth0-primary`), even in shadcn projects. This is because the prop sets inline styles on the component wrapper, bypassing your Tailwind build.
