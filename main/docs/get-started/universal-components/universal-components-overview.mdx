...
Universal Components are grouped by the Auth0 API they target and the platform you're building on.

<CardGroup cols={2}>
  <Card
    title="My Organization (Web)"
    icon="building"
    href="/docs/get-started/universal-components/my-organization/build-delegated-admin"
  >
    React, Next.js, and shadcn components for delegated admin — let your business customers manage their own Auth0 Organizations, Single Sign-On providers, and domains.
  </Card>
  <Card
    title="My Account (iOS & Android)"
    icon="mobile"
    href="/docs/get-started/universal-components/my-account/build-account-security"
  >
    SwiftUI and Jetpack Compose components for end-user self-service — let users enroll, review, and remove MFA factors, passkeys, and recovery codes from within your app.
  </Card>
</CardGroup>

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Installing the native SDK? Start with [Install the Native SDK](/docs/get-started/universal-components/native/native-overview) for iOS (Swift Package Manager, CocoaPods, Carthage) and Android (Gradle).
</Callout>
